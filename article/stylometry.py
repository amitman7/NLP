...
# old data create
old_data = StyloCorpus.from_glob_pattern('stylometry-data/old/*.txt')
old_data.output_csv('old_ALL.csv')

# new data create
new_data = StyloCorpus.from_glob_pattern('stylometry-data/new/*.txt')
new_data.output_csv('new_ALL.csv')


# Load data from CSV file old.csv
old_data = pd.read_csv("old_ALL.csv",encoding="windows-1255")
...
new_data = pd.read_csv("new_ALL.csv",encoding="windows-1255")
...
s.output_csv('prediction_check.csv')


new_data = pd.read_csv("prediction_check.csv",encoding="windows-1255")
