...
def main():
    ...
    # syntax
    print(" VERB_old/VERB_new =",VERB_st_old/VERB_st_new,"\n","ADV_old/ADV_new=",ADV_st_old/ADV_st_new,"\n","ADJ_old/ADJ_new=",ADJ_st_old/ADJ_st_new,"\n","NOUN_old/NOUN_new=",NOUN_st_old/NOUN_st_new,"\n","DET_old/DET_new=",DET_st_old/DET_st_new,"\n","ADP_old/ADP_new=",ADP_st_old/ADP_st_new,"\n","PRON_old/PRON_new=",PRON_st_old/PRON_st_new,"\n","AUX_old/AUX_new=",AUX_st_old/AUX_st_new,"\n","PUNCT_old/PUNCT_new=",PUNCT_st_old/PUNCT_st_new,"\n","SCONJ_old/SCONJ_new=",SCONJ_st_old/SCONJ_st_new,"\n","INTJ_old/INTJ_new=",INTJ_st_old/INTJ_st_new,"\n","NUM_old/NUM_new=",NUM_st_old/NUM_st_new,"\n","PROPN_old/PROPN_new=",PROPN_st_old/PROPN_st_new,"\n","CCONJ_old/CCONJ_new=",CCONJ_st_old/CCONJ_st_new,"\n","X_old/X_new=",X_st_old/X_st_new,"\n")
    # Word mean length
    print("Old word mean / new word mean: =",word_len_old/word_len_new,"\n")
    # sentence mean length
